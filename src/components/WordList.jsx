...
export default function WordList({ edit, editSetter }) {
  ...
  function handleEdit(word) {
    ...
    editSetter({
      id: word.id,
      earthWord: word.earthWord,
      alienWord: word.alienWord,
    ...
    <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg mt-8">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        words.map((word, index) => (
          <div
            key={word.alienWord + toString(index)}
            className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full mx-auto my-4 hover:shadow-xl transition-all relative"
          >
            <div className="absolute top-2 right-2 flex space-x-2">
              ...
              <button
                className="text-red-500 p-1  px-0 rounded-full hover:bg-red-100 focus:outline-none"
            ...
            <h2 className="text-xl font-bold text-black-500 mb-2">
              {word.earthWord} → {word.alienWord}
            </h2>
